...
1.  **Verify External Tools**
    ...
    - For each tool, run a version check command (e.g., `git --version`) with `SafeToAutoRun: true`.
...
2. **Install Python Dependencies**
    ...
    - Run: `python .agent/skills/init/scripts/install_deps.py`
    ...
    - Use `SafeToAutoRun: true` for this command as it's a safe installation step.
...
4.  **Save Profile (in English)**
    ...
    - Save the result to `../about-me/resources/profile.md`.
